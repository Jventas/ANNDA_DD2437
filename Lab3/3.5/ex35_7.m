...
for nnn = 1:Iterations
    ...
    for nn = 1:nPatterns
        % New random pattern
        randpattern = sign(0.5+randn(1,d));
...
title('Stable and recovered patterns vs number of learnt patterns (average in 100 iterations) - Without Self Connections')
legend('Stable patterns (Without self-connections)','Recovered patterns (Without self-connections)','Location','Best')
grid on
hold off
