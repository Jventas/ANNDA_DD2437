...
class DeepBeliefNet_431():    
    ...
    def recognize(self,true_img,true_lbl):
        ...
        # Bottom-up
        print("vis--hid")
        h2 = self.rbm_stack["vis--hid"].get_h_given_v_dir(vis)[1]
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try :
            ...
            self.loadfromfile_rbm(loc="trained_rbm_431",name="vis--hid")
            self.rbm_stack["vis--hid"].untwine_weights()            

            # In the last one weights are symmetric
            self.loadfromfile_rbm(loc="trained_rbm_431",name="pen+lbl--top")        
            ...
            self.savetofile_rbm(loc="trained_rbm_431",name="vis--hid")
            self.rbm_stack["vis--hid"].untwine_weights()            
            ...
            h2_trainset_data = self.rbm_stack["vis--hid"].get_h_given_v_dir(vis_trainset)[0]
            ...
            self.savetofile_rbm(loc="trained_rbm_431",name="pen+lbl--top")   
    ...
    def train_wakesleep_finetune(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try :
            ...
            self.loadfromfile_dbn(loc="trained_dbn_431",name="vis--hid")
            self.loadfromfile_rbm(loc="trained_dbn_431",name="pen+lbl--top")
            ...
            for it in range(n_iterations):  
                ...
                vis_down = self.rbm_stack["vis--hid"].get_v_given_h_dir(h2_down)[1]
                ...
                """
                vis_pred_gen = self.rbm_stack["vis--hid"].get_v_given_h_dir(h2)[0]

                h2_pred_rec = self.rbm_stack["vis--hid"].get_h_given_v_dir(vis_down)[0]
                ...
                self.rbm_stack["vis--hid"].update_generate_params(h2,vis,vis_pred_gen)
                ...
                self.rbm_stack["vis--hid"].update_recognize_params(vis_down,h2_down,h2_pred_rec)

                if it % self.print_period == 0 : print ("iteration=%7d"%it)
                        
            self.savetofile_dbn(loc="trained_dbn_431",name="vis--hid")
            self.savetofile_rbm(loc="trained_dbn_431",name="pen+lbl--top")            
