...
% NN creation
nLayers = 2;
nHidden = [22]; % Number of hidden nodes per layer (if more than 2 hiddenLayers => row vector)
...
net.divideParam.trainInd = 1:700; % Adjust use of inputs
net.divideParam.valInd = 701:1000;
...
net.performParam.regularization = 0.01; %Regularization
