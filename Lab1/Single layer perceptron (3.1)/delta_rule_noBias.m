...
%With no bias, it can't classify inputs correctly if both groups are in the
%same quadrant
...
nInputs = 2;
nOutputs = 1;
mA = [ 1, 1]; sigmaA = 0.4; % Mean and std. dev of A
mB = [ -1, -1]; sigmaB = 0.4; % Mean and std. dev of B
...
rate = 0.001; % learning rate or step size
W = 0.2*randn(nOutputs,nInputs); % Random initialization of W = [w1 w2 theta]
...
deltaW = [1000 1000]; % initial deltaW
mse = [];
deltaErr = 1000;
